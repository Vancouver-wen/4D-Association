...
model_coco = './weight/body_coco.pth'
...
class torch_openpose(object):
    ...
    def __call__(self, oriImg,scale_search = [0.5, 1.0, 1.5, 2.0]):
        scale_search = [0.7, 1.0, 1.3] # issues this scale search option is better
        boxsize = 368
        stride = 8
        padValue = 128
        thre1 = 0.1
        ...
        maps=Parallel(n_jobs=len(multiplier),backend="threading")(
